...
import pe.com.apiescuealanueva.EscuelaNueva.service.ParentescoService;
...
public class ParentescoController {
    ...
    public ParentescoEntity update(@PathVariable Long id){
        ParentescoEntity obParentescoEntity = new ParentescoEntity();
        obParentescoEntity.setEstado(false);
