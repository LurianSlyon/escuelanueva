...
import pe.com.apiescuealanueva.EscuelaNueva.service.DistritoService;
...
public class DistritoController {
    ...
    public DistritoEntity update(@PathVariable Long id){
        DistritoEntity obDistritoEntity = new DistritoEntity();
        obDistritoEntity.setEstadod(false);
